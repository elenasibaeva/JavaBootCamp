...
public class CustomExceptionActivityTest {
    ...
    public static void main(String[] args) {
        try {
            ...
            customExceptionActivityTest.validateUser("Jane");
            customExceptionActivityTest.validateUser("Jack");
            customExceptionActivityTest.validateUser("Jade");
            customExceptionActivityTest.validateUser("Jacob");
        }
    ...
    void validateUser(String name) throws CustomExceptionActivity {
        ...
        //array of names
        String[] validUsers = {"John","Jane","Jack","Jade","Jacob"};
